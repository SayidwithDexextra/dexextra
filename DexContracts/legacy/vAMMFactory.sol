...
contract vAMMFactory {
    ...
    function createMarket(
        ...
        emit ContractDeployed(marketId, vammAddress, "vAMM", abi.encode(vaultAddress, oracle, initialPrice));
    ...
    function recoverToken(address token, uint256 amount) external onlyOwner {
        // Emergency recovery function - implementation depends on specific token contract
        // This function is left empty for security reasons
        // Owner should use direct contract interactions if needed
    }
} 