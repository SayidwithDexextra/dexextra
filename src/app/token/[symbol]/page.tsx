...
// Comments hook with real-time updates
  ...
  const marketInfoHeaderProps = useMemo(() => {
    ...
    return {
      ...
      settlementDisputed: market.settlement_disputed === true,
      umaEscalated: Boolean(market.market_config?.uma_assertion_id),
      umaResolved: market.market_config?.uma_resolved === true,
