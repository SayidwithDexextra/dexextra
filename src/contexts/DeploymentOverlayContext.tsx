    ...
    >
      <div className="flex items-start justify-between gap-3 p-3">
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-2 text-[10px] text-white truncate leading-snug" title={msg}>
            {msg}
          </div>
        </div>
        <div className="flex flex-col items-end gap-2">
          ...
          {marketSymbol ? (
            <button
              onClick={openMarket}
              className="text-[10px] text-[#8a8a8a] hover:text-white bg-transparent border border-[#222222] hover:border-[#333333] rounded px-2.5 py-1.5 transition-all duration-200"
            >
              Open market
            </button>
          ) : null}
      ...
      <div className="p-3">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-1 text-[10px] text-white truncate leading-snug">
              {marketSymbol} is ready.
            </div>
          </div>
          <button
            onClick={onDismiss}
            className="text-[10px] text-[#606060] hover:text-white border border-[#222222] hover:border-[#333333] rounded px-2.5 py-1.5 transition-all duration-200"
          >
            Dismiss
          </button>
        </div>
        <div className="mt-3 flex gap-2">
          <button
            ...
            className="text-[10px] text-black bg-green-400 hover:bg-green-300 rounded px-3 py-2 transition-all duration-200"
          >
            Open market
          </button>
          <button
            ...
            className="text-[10px] text-white bg-[#1A1A1A] hover:bg-[#2A2A2A] border border-[#222222] hover:border-[#333333] rounded px-3 py-2 transition-all duration-200"
            title="Copy symbol"
          >
            Copy symbol
          </button>
