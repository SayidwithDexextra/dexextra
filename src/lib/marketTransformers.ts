...
import { OrderbookMarket } from '@/hooks/useOrderbookMarkets';

/**
 * Transforms an OrderbookMarket to MarketTickerCardData format
 */
...
/**
 * Transforms an array of OrderbookMarkets to MarketTickerCardData format
 */
 ...
 */
export function filterActiveMarkets(markets: OrderbookMarket[]): OrderbookMarket[] {
 ...
 */
export function sortMarketsByPriority(markets: OrderbookMarket[]): OrderbookMarket[] {
