...
const FixedStepFooter: React.FC<FixedStepFooterProps> = ({
  ...
  return (
    <div className="fixed bottom-[60px] left-1/2 transform -translate-x-1/2 z-30">
      <div className="bg-white border border-gray-200 rounded-lg shadow-lg px-4 py-3 w-[540px] max-w-[calc(100vw-40px)]">
        ...
        <div className="flex justify-between text-xs text-gray-500 mb-3">
          ...
          <span className={currentStep === 2 ? 'text-black font-medium' : ''}>Trading</span>
          <span className={currentStep === 3 ? 'text-black font-medium' : ''}>Settlement</span>
          <span className={currentStep === 4 ? 'text-black font-medium' : ''}>Images</span>
          <span className={currentStep === 5 ? 'text-black font-medium' : ''}>Deploy</span>
        </div>
