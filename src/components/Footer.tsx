  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* How it works */}
        <Link
          href="https://doc.dexetera.org/docs/intro"
          target="_blank"
      ...
      >
        <Link 
          href="https://dexetera.org/dexetera-tos.html"
          target="_blank"
          rel="noopener noreferrer"
          style={{
            padding: '4px 8px',
        ...
        <Link 
          href="https://dexetera.org/dexetera-privacy.html"
          target="_blank"
          rel="noopener noreferrer"
          style={{
            padding: '4px 8px',
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          ...
          <a 
            href="https://discord.com/invite/ntVTBwhTd"
            target="_blank"
            rel="noopener noreferrer"
            style={{
              width: '20px',
