...
export default function TokenList({ 
  ...
  return (
    <div className="space-y-1">
      {/* Section Header */}
      {onRefresh && (
        <div className="group flex items-center justify-between px-2.5 pt-2.5 mb-2">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              onClick={handleRefresh}
              disabled={refreshing}
              className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 p-1 hover:bg-blue-500/10 rounded text-blue-400 hover:text-blue-300 disabled:opacity-50 disabled:cursor-not-allowed"
