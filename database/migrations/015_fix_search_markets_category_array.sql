-- Fix search_markets RPC: category column was migrated from VARCHAR(50) to text[]
-- but the function was never updated, causing it to fail on every invocation with:
--   ERROR 42883: operator does not exist: text[] = character varying
