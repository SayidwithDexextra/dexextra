...
interface IFeeRegistry {
    ...
    function gasPriceWei() external view returns (uint256);
    function protocolFeeRecipient() external view returns (address);
    function getGasFeeConfig() external view returns (uint256 _hypeUsdcRate6, uint256 _maxGasFee6, uint256 _gasEstimate, uint256 _gasPriceWei);
