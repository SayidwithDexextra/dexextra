...
require("dotenv").config({ path: "Hyperliquid/.env" });
...
async function main() {
  ...
  if (!process.env.PRIVATE_KEY) {
    console.log("❌ PRIVATE_KEY not found in Hyperliquid/.env");
    console.log("💡 Please add your private key to Hyperliquid/.env file");
